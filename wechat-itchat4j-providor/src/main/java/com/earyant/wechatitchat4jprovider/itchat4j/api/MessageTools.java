package com.earyant.wechatitchat4jprovider.itchat4j.api;
...
import com.earyant.wechatitchat4jprovider.itchat4j.utils.enums.VerifyFriendEnum;
...
public class MessageTools {
    ...
    private void sendMsg(String text, String toUserName, User core) {
        ...
        LOG.info(String.format("send message %s: %s", toUserName, text));
    ...
    private JSONObject webWxUploadMedia(String filePath, User core) {
        ...
        String url = String.format(URLEnum.WEB_WX_UPLOAD_MEDIA.getUrl(), core.getFileUrl());
        ...
        String passTicket = (String) core.getPass_ticket();
        ...
        if (entity != null) {
            try {
                ...
                LOG.error("webWxUploadMedia error： ", e);
            }
    ...
    private boolean webWxSendMsgImg(String userId, String mediaId, User core) {
        ...
        if (entity != null) {
            try {
                ...
                LOG.error("webWxSendMsgImg error： ", e);
            }
        }
        return false;
    ...
    public boolean sendFileMsgByUserId(String userId, String filePath, User core) {
        ...
        if (responseObj != null) {
            ...
            LOG.error("sednFileMsgByUserId error: ", data);
        }
