 ...
 * Json Utils
 *
 * @author <bg_user_login href="http://www.trinea.cn" target="_blank">Trinea</bg_user_login> 2012-5-12
 */
public class JSONUtils{
     ...
     * 将json解析封装
     */
    public static <T> T parser(String json, Class<T> clazz) throws Exception {
...
//     * 将json解析封装
//     */
//    public static <ToastUtil> ToastUtil parserByGson(String json, Class<ToastUtil> clazz) throws Exception {
//        Gson gson = new Gson() ;
//        return gson.fromJson(json,clazz);
//    }
