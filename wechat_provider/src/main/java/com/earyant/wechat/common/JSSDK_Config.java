...
//     * @date 2016年3月19日 下午3:53:23
//     */
//    public  HashMap<String, String> jsSDK_Sign(String url,String appid) throws Exception {
//        String nonce_str = create_nonce_str();
//        String timestamp = wechatConfigService.timestamp();
////                GlobalConstants.getInterfaceUrl("timestamp");
//        String jsapi_ticket = wechatConfigService.jsapi_ticket();
////                GlobalConstants.getInterfaceUrl("jsapi_ticket");
//        // 注意这里参数名必须全部小写，且必须有序
